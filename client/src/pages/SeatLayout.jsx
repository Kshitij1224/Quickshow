...
import { ArrowRightIcon, Clock1Icon } from "lucide-react"
...
const SeatLayout = () => {
  ...
  const [selectedSeats, setSelectedSeats] = useState([])   // 🔹 Added missing state
  ...
  const renderSeats = (row ,count=9)=>(
    <div key={row} className='flex gap-2 mt-2'>
      <div className='flex flex-wrap items-center justify-center gap-2'>{/* 🟢 Fixed flex-wrap */}
  ...
  if (!show) return <p className="text-center text-gray-700 py-10">Loading...</p>
