...
const SeatLayout = () => {
          ...
          return (
            <button
              ...
              className={`h-8 w-8 rounded border cursor-pointer transition ${
                isOccupied 
                  ? "bg-gray-500 text-white border-gray-500 cursor-not-allowed opacity-50" 
                  : isSelected 
  ...
  if (!show) return <p className="text-center py-10">Loading...</p>

  return (
    <div className='flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50'>

      {/* Timings */}
      <div className='w-60 bg-primary/10 border rounded-lg py-10 h-max md:sticky md:top-30'>
